...
if [ "$1" = "$FDEVICE" -o "$FOX_BUILD_DEVICE" = "$FDEVICE" ]; then
	...
	export OF_TARGET_DEVICES="ebba,Ebba,OnePlusNordCE,NordCE,nordce,OPNordCE,oneplusnordce"
	export TARGET_DEVICE_ALT="Ebba,OnePlusNordCE,NordCE,nordce,OPNordCE,oneplusnordce"
    ...
    export OF_MAINTAINER="GriefNorth"
